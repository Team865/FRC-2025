...
public class ClimberIOTalonFX implements ClimberIO {
    ...
    public void updateInputs(ClimberIOInputsAutoLogged inputs) {
        boolean motorConnected = BaseStatusSignal.refreshAll(position, angularVelocity, appliedVolts, supplyCurrent).isOK(); 
        boolean followerConnected = BaseStatusSignal.refreshAll(followerAppliedVolts, followerSupplyCurrent).isOK(); 
        ...
        inputs.pivotAppliedVolts = new double[] {appliedVolts.getValueAsDouble(),followerAppliedVolts.getValueAsDouble() };
        inputs.pivotCurrentAmps = new double[] { supplyCurrent.getValueAsDouble(),followerSupplyCurrent.getValueAsDouble() }; 
    }
    @Override
